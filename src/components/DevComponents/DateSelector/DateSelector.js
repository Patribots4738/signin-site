...
const DateSelector = ({ onSubmit }) => {
    ...
    const pushDay = (days, day, monthOffset = 0, className = '') => {
        ...
        const isToday = displayedDate.toDateString() === today.toDateString()
        days.push(
    ...
    return (
        <div className="date-selector">
            ...
            <table>
                <thead>
                    <tr>
                        <td className="hoverable" data-day="Sunday">
                            S
                        </td>
                        <td className="hoverable" data-day="Monday">
                            M
                        </td>
                        <td className="hoverable" data-day="Tuesday">
                            T
                        </td>
                        <td className="hoverable" data-day="Wednesday">
                            W
                        </td>
                        <td className="hoverable" data-day="Thursday">
                            T
                        </td>
                        <td className="hoverable" data-day="Friday">
                            F
                        </td>
                        <td className="hoverable" data-day="Saturday">
                            S
                        </td>
                    </tr>
                </thead>
